...
const liquidityDetails = [
 ...
 value: "15M OCH",
 description: "Allocated to the initial liquidity position.",
 },
 {
 label: "Initial ETH Liquidity",
 value: "7.5 ETH",
 description: "ETH side of the initial liquidity position.",
 },
 {
 ...
 value: "20%",
 description:
 "20,000,000 OCH allocated to initial and future liquidity.",
 },
];
...
export default function OCHPage() {
 ...
 {contractIsLive
 ? `Official $OCH contract: ${OCH_CONTRACT_ADDRESS}`
 ...
 A fixed-supply ERC-20 connecting Hoodies, participation and the programmable HoodWallet layer.
 </p>
 ...
 Every Hoodie receives the same Hoodie allocation
 across three rounds. Traits define identity, not allocation
 value.
 </p>
 ...
 Season 01 rewards native on-chain Hood Talk activity. The first
 qualifying activation receives the full reward; the second and third
 activations receive progressively smaller rewards.
 </p>
 ...
 <p className="mt-3 text-3xl">{HOOD_TALK_FIRST_REWARD}</p>
 ...
 Current Hood Talk state: {HOOD_TALK_QUALIFYING_HOODIES.toLocaleString()}
 unique Hoodies spoken. Final rewards follow recorded Season 01 activations.
 </p>
 </article>
 ...
 activation, the account can receive supported assets.
 $OCH is used to activate the wallet for the current Hoodie
 owner.
 </p>
 ...
 Sent directly to the Hoodie&apos;s Token Bound Account.
 The Hoodie receives the asset - not the owner wallet.
 </p>
 </div>
 </div>
 </div>
 ...
 <p className="mt-8 max-w-lg text-lg leading-relaxed opacity-75 md:text-xl">
 20% of total $OCH supply is allocated to liquidity.
 15% is allocated to the initial pool and 5% is reserved
 exclusively for future liquidity deployment.
 </p>
 </div>
 ...
 The initial LP position is project-admin controlled.
 The 5,000,000 OCH liquidity reserve is earmarked for additional
 liquidity and released by the protocol administrator.
 </p>
 </div>
 </div>
 </section>
 ...
 <p className="mt-8 max-w-lg text-lg leading-relaxed opacity-75 md:text-xl">
 The Hood Treasury supports ecosystem operations,
 development, experimentation and future OnChainHoodies
 initiatives.
 </p>
 </div>
 ...
 development and documented on-chain experiments,
 including potential acquisitions of Hoodies or other
 ecosystem assets.
 </p>
 ...
 <p className="mt-5 max-w-4xl text-lg leading-relaxed md:text-2xl">
 $OCH has 0% buy, sell and transfer tax.
 HoodWallet activation is a separate ecosystem utility with an
 initial fee of {INITIAL_ACTIVATION_FEE}.
 </p>
 </div>
 </div>
 </div>
 ...
 <p className="mt-8 max-w-lg text-lg leading-relaxed opacity-75 md:text-xl">
 Season 01 participation is complete. The final season recognized
 Hoodie ownership, Hood Talk, submitted X contributions and verified
 Hoodie PFP participation.
 </p>
